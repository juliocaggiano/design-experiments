...
export const SHADCN_DEFINITIONS = [
  {
    ...
    date: 'Jul 16, 2026',
    category: 'Interfaces',
    summary: 'The official attachment demo combines an image strip with uploading and completed file rows.',
    detail: 'It preserves the base-rhea image crops, filenames, metadata, spinner, shimmer state, and trailing removal actions.',

...
function SkeletonReveal({ controls }: SpecimenProps) {
  ...
  return (
    <Specimen label="Loading frame and content reveal" className="td-skeleton-demo">
...
function ShimmerText({ controls }: SpecimenProps) {
  ...
  return (
    <Specimen label="Thinking text" className="td-shimmer-demo">
  ...
  return (
    <Specimen label="Grid row accordion transition" className="td-accordion-demo">
      <div className="td-accordion" data-open={open ? 'true' : 'false'}>
        <button type="button" onClick={replay} aria-expanded={open}><span><Users size={16} /> best spider man</span><CaretDown size={16} weight="bold" /></button>
        <div className="td-accordion-track"><div className="td-accordion-panel">
          <label><span><UserCircle size={16} /> Tom Holland</span><input type="radio" name="td-spider-man" defaultChecked /></label>
          <label><span><UserCircle size={16} /> Andrew Garfield</span><input type="radio" name="td-spider-man" /></label>
          <label><span><UserCircle size={16} /> Toby Maguire</span><input type="radio" name="td-spider-man" /></label>
        </div></div>
      </div>
    </Specimen>
  )

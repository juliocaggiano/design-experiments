...
export const VAULT_ITEMS: readonly VaultItem[] = [
  { path: '/vault/meeting-overlay', title: "Don't Miss Meetings", date: 'Jul 8, 2026', category: 'Motion' },
  { path: '/vault/reactive-dither', title: 'Liquid Dither Effect', date: 'Jul 18, 2026', category: 'Motion' },
  { path: '/vault/liquid-connector', title: 'Liquid Connector', date: 'Jul 18, 2026', category: 'Motion' },
  { path: '/vault/skill-design-eng', title: 'Design Engineering', date: 'Jul 16, 2026', category: 'Skills' },
